            ...
            <div class="border-b border-gray-900/10 pb-12">
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <x-form-field>
                        ...
                        <div class="mt-2">
                            <x-form-input name="first_name" id="first_name" type="text"  autocomplete="title" required></x-form-input>
                    ...
                    <x-form-field>
                        ...
                        <div class="mt-2">
                            <x-form-input name="last_name" id="last_name" type="text"  autocomplete="last_name" required></x-form-input>
                    ...
                    <x-form-field>
                        ...
                        <div class="mt-2">
                            <x-form-input name="password_confirmation" id="password_confirmation" type="password"  autocomplete="password" required></x-form-input>
